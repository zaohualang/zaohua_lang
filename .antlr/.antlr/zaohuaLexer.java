...
public class zaohuaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "IF", "ELSE", "ELIF", "FOR", "FUNC", 
			"RETURN", "IN", "TRUE", "FALSE", "PLUS", "MINUS", "MUL", "DIV", "MOD", 
			"EQ", "NEQ", "GT", "LT", "GTE", "LTE", "ASSIGN", "DECLARE_ASSIGN", "COLON", 
			"SEMI", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "BOOLEAN", "ID", 
			"NUMBER", "NEWLINE", "STRING", "LINE_COMMENT", "WS"
		};
	}
	...
	public zaohuaLexer(CharStream input) {
		super(input);
